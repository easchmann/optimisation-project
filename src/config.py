...
ALGO_PARAMS: dict[str, dict] = {
    ...
    "hybrid_ga_sa": {
        "n_pop": 80, "p_cx": 0.8, "p_mut": 0.3, "p_ind": 0.02, "n_gen": 120,
        "n_elite": 2, "t_size": 5, "elitism": True,
        "sa_steps": None,  # 15*n at runtime
        "sa_T0": 6.0, "sa_gamma": 0.95, "sa_refine_fraction": 0.12,
    },
    "hybrid_aco_sa": {
        "aco_iter": 100, "aco_ants": 50, "aco_alpha": 2.0, "aco_beta": 5.0,
        "aco_rho": 0.2, "aco_Q": 1.0,
        "sa_steps": None,  # 100*n at runtime
        "sa_T0": 20.0, "sa_gamma": 0.99, "sa_restarts": 3,
    },
}
